		...
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<?php 
							$query="SELECT C.*,'ACTIVE' as STATUS FROM cc_m_upload_products C where fm_uname='$farmer_name'";
					 ?>
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
						...
						{?>	
						 <tr>
								...
								<td class="center">
									<a class="btn btn-danger" href='deleteproducts.php?productid=<?php echo $row['pid']; ?>'>
...
function removeproduct($prod_id)
	{
		include 'db_connect.php';
		$query="DELETE FROM cc_m_products WHERE pid=$prod_id";
		//echo $query;
		mysqli_query($conn,$query);
		$query="DELETE FROM cc_m_upload_products WHERE pid=$prod_id";
		//echo $query;
		mysqli_query($conn,$query);
