	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="viewproducts.php">View Farmers</a></li>
			</ul>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<?php 
							$query="SELECT C.*,'ACTIVE' as STATUS,D.sys_creation_date as added_on FROM cc_m_farmer_details C,cc_m_farmer D where D.fm_active_ind='Y'";
				...
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
						...
						{?>	
						 <tr>
								...
								<td class="center"><?php echo $row['fm_bank_name']; ?></td>
								<td class="center"><?php echo $row['fm_branch_name']; ?></td>
								<td class="center"><?php echo $row['added_on']; ?></td>
								<td class="center"><?php echo $row['STATUS']; ?></td>
								<td class="center"><?php echo $row['fm_account_no']; ?></td>
								<td class="center"><?php echo $row['fm_ifsc_code']; ?></td>
